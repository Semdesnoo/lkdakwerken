...
export const projecten = [
  ...
  },
  {
    ...
    jaar: 2024,
    image: "project-06",
    tekst: "De oude laag was kaal en kwetsbaar geworden. Wij legden een nieuwe bitumenlaag met leislag, die de zon reflecteert en het materiaal langer soepel houdt. Klaar voor de volgende twintig jaar.",
  },
  {
    titel: "Berging bij de rij woningen",
    plaats: "Spijkenisse",
    type: "Nieuwe dakbedekking",
    oppervlakte: "26 m²",
    jaar: 2024,
    image: "project-07",
    tekst: "Een ochtend werk met de ladder in de tuin. Oude laag eraf, nieuwe erop, planken en rommel netjes meegenomen. Zo hoort het, ook bij een klus van een paar uur.",
  },
  {
    ...
    jaar: 2025,
    image: "project-08",
    tekst: "Een fors dak boven de hele woonverdieping, in één dag dicht. De banen liggen strak in lijn en de aluminium dakrand loopt rondom door. Vanaf de tuin zie je alleen een kaarsrechte lijn.",
  },
  {
    titel: "Plat dak met terras eronder",
    plaats: "Ridderkerk",
    type: "Nieuwe dakbedekking",
    oppervlakte: "88 m²",
    jaar: 2025,
    image: "project-09",
    tekst: "De familie zat op het terras terwijl wij boven werkten. Nieuwe leislagbitumen, dakrand rondom en aan het eind van de dag geen enkele restant op de tegels. Netjes werken hoort erbij.",
  },
  {
    titel: "Dakvernieuwing met doorvoeren",
    plaats: "Barendrecht",
    type: "Renovatie",
    oppervlakte: "80 m²",
    jaar: 2025,
    image: "project-10",
    tekst: "Rondom de dakdoorvoeren gaat het altijd mis op een oud dak. Wij pakten elke doorvoer apart aan met extra manchetten, zodat juist die kwetsbare punten de komende jaren het langst meegaan.",
  },
  {
    titel: "Plat dak met brede randzone",
    plaats: "Rotterdam Zuidwijk",
    type: "Nieuwe dakbedekking",
    oppervlakte: "90 m²",
    jaar: 2024,
    image: "project-11",
    tekst: "Een dak dat er jaren verwaarloosd bij lag. Nieuwe laag met leislag, zwarte randstrook langs de opstand en een aluminium trim die het geheel afmaakt. Verschil van dag en nacht.",
  },
  {
    titel: "Dakrenovatie met lichtkoepel",
    plaats: "Hendrik-Ido-Ambacht",
    type: "Renovatie",
    oppervlakte: "85 m²",
    jaar: 2025,
    image: "project-12",
    tekst: "De lichtkoepel bleef staan, de rest ging eraf. Wij werkten de aansluiting rondom de koepel opnieuw op, want daar begint bij negen van de tien daken de eerste lekkage.",
  },
  {
  ...
  {
    titel: "Plat dak aan de achterzijde",
    plaats: "Krimpen aan den IJssel",
    type: "Nieuwe dakbedekking",
    oppervlakte: "76 m²",
    jaar: 2024,
    image: "project-14",
    tekst: "Nieuwe leislagbitumen tot aan de opstand bij de gevel, met de goot aan de rechterzijde opnieuw aangesloten. Het regenwater loopt weer precies waar het hoort.",
  },
  {
    titel: "Woonhuisdak rondom vernieuwd",
    plaats: "Rotterdam IJsselmonde",
    type: "Nieuwe dakbedekking",
    oppervlakte: "84 m²",
    jaar: 2025,
    image: "project-15",
    tekst: "Een dak vol doorvoeren en een lichtkoepel middenin. We hebben de volgorde omgedraaid: eerst alle details waterdicht, daarna pas de vlakken. Dat scheelt later herstelwerk.",
  },
  {
  ...
  {
    titel: "Kleine dakvlak bij de voordeur",
    plaats: "Maassluis",
    type: "Nieuwe dakbedekking",
    oppervlakte: "14 m²",
    jaar: 2024,
    image: "project-19",
    tekst: "Niet elk werk hoeft groot te zijn. Dit dakje boven de entree kreeg een nieuwe laag, een nette dakrand en een goed werkende afvoer. De bus stond er een halve dag, daarna weer weg.",
  },
  {
